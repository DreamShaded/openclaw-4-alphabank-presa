...
const backgroundsDark = import.meta.glob(
	"../assets/images/backgrounds/dark/interjection/*.jpg",
	{ eager: true, query: "?url", import: "default" },
);
const backgroundsLight = import.meta.glob(
	"../assets/images/backgrounds/light/interjection/*.jpg",
	{ eager: true, query: "?url", import: "default" },
);
...
const backgroundUrl = computed(() => {
	...
	const key = `../assets/images/backgrounds/${mode}/interjection/interjection_${variant}.jpg`;
...
<template>
  <div 
    class="slidev-layout interjection"
...
<style scoped>
/* Минимально: размеры шрифтов задаются глобальной типографикой */
</style>
